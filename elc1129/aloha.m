...
%simulação do protocolo Aloha puroc
...
%intervalo/passo de tempo da simulação
dt_sim = t_quadro/tam_quadro; % igual a 1/taxa_bits
...
hold on;
%figure(1)
plot((quadros_entregues+quadros_colididos)*tam_quadro/tempo,...
    quadros_entregues*tam_quadro/tempo,'ro',...
    G*taxa_bits,S*taxa_bits,'-')
grid
